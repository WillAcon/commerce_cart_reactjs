...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_cart_add__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_cart_complement__ = __webpack_require__(28);
...
if (document.getElementById('reactCartAdd')) {
  Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"])(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__components_cart_add__["a" /* default */], null), document.getElementById('reactCartAdd'));
}

if (document.getElementById('reactCartComplement')) {
  Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"])(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__components_cart_complement__["a" /* default */], null), document.getElementById('reactCartComplement'));
}
...
var CartBlock = function (_Component) {
  ...
  babelHelpers.createClass(CartBlock, [{
    ...
    value: function getCarts() {
      ...
      console.log('Getting cart block');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_superagent__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_superagent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_superagent__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__cart__ = __webpack_require__(27);





var CartAdd = function (_Component) {
  babelHelpers.inherits(CartAdd, _Component);

  function CartAdd(props) {
    babelHelpers.classCallCheck(this, CartAdd);

    var _this = babelHelpers.possibleConstructorReturn(this, (CartAdd.__proto__ || Object.getPrototypeOf(CartAdd)).call(this, props));
  ...
  babelHelpers.createClass(CartAdd, [{
    key: 'getCarts',
    value: function getCarts() {
      var _this2 = this;
...
var Cart = function (_Component) {
  ...
  function Cart(props) {
    babelHelpers.classCallCheck(this, Cart);
    return babelHelpers.possibleConstructorReturn(this, (Cart.__proto__ || Object.getPrototypeOf(Cart)).call(this, props));
    // this.state = {
    //   // Copy the prop into state so we can refresh it.
    //   cart: props.cart,
    //   cartId: props.cart.order_id,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_superagent__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_superagent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_superagent__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__productos__ = __webpack_require__(29);
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'modal-background', onClick: this.onClickOpenC1 }),
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('button', { onClick: this.onClickOpenC1, className: 'modal-close is-large', 'aria-label': 'close' })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          {
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__productos__["a" /* default */], { complementos: this.state.complementos, cargar: this.setProducts }),
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            this.state.complementos.map(function (item) {
              return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { key: item.cid, className: 'column is-one-quarter', 'data-id': item.cid, onClick: function onClick() {
                    return _this2.onClickSelect(item);
                  } },
                item.cid,
                item.producto,
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            { className: 'button is-primary', onClick: function onClick() {
                return _this2.props.cargar(_this2.state.addCart);
              } },
            'Guardar'
          )
        )
