    ...
    return (
       <div>
          ...
          </ProductVariationItem>
          {
            ...
            >
              <Complements type={util.complement} />              
              <div className="complement__close icon__close" onClick={this.closeModal}></div>
              <div className="has-text-centered">
                <div className="mt-default button is-custom" onClick={this.openComplementBlock}>Ver Carrito</div>
              </div>
            </ReactModal>
          }
