...
const ButtonProductComponent = (
  <Provider store={store}>
    <ProductButton />
  </Provider>
)

if (document.getElementsByClassName('add-to-cart-ajax-link')) {
  render(ButtonProductComponent, document.getElementsByClassName('add-to-cart-ajax-link'));
}